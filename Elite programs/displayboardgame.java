 ...
 * 
 * Tejaswi has to select the numbers, such that no more numbers will be left
 * over
 * on the board.
 * 
 ...
 * Explanation:
 * ------------
 * Pick a number 5 to score 5 points, simultaneously 4 is disappeared from
 * display.
 ...
 * Explanation:
 * -------------
 * Pick a number 5 to score 5 points, simultaneously all 4's and 6 are
 * disappeared
